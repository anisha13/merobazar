...
<body>
  ...
  <section class="material-half-bg" style="background-color: #1609c4 !important;">
  ...
  <section class="login-content" style="background-color: #1609c4 !important;">
    <div class="logo">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.min.js" integrity="sha384-w1Q4orYjBQndcko6MimVbzY0tgp4pWB4lZ7lr30WKz0vr/aWKhXdBNmNb5D92v7s" crossorigin="anonymous"></script>
  ...
  <!-- <script src="{{asset('public/back/stylejs/jquery-3.2.1.min.js')}}"></script>
  <script src="{{asset('public/back/stylejs/popper.min.js')}}"></script>
  <script src="{{asset('public/back/stylejs/bootstrap.min.js')}}"></script>
  <script src="{{asset('public/back/stylejs/main.js')}}"></script> -->
  <!-- The javascript plugin to display page loading on top-->
  <script src="{{asset('public/back/stylejs/plugins/pace.min.js')}}"></script>
